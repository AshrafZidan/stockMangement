...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">كود - <?php echo $return_code ?></h4>
    </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=return/manage_return&id='.(isset($id) ? $id : '') ?>">تعديل</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=return' ?>">العودة للقائمة</a>
    </div>
</div>
