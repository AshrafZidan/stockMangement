...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo isset($id) ? "تفاصبل المرتجع - ".$return_code : 'اضافة مرتجع جديد' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="return-form">
            ...
            <div class="container-fluid">
                ...
                <hr>
                <fieldset>
                    <legend class="text-info">معلومات المنتجات</legend>
    ...
    <div class="card-footer py-1 text-center">
        <button class="btn btn-flat btn-primary" type="submit" form="return-form">حفظ</button>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=return' ?>">الغاء</a>
    </div>
</div>
...
<script>
    ...
    list_item.then(function(){
        ...
        $('#add_to_list').click(function(){
            ...
            if(item == '' || qty == '' || unit == '' ){
                alert_toast('ادخل كل البيانات.','warning');
                return false;
            }
