    ...
    <div id='transaction-printable-details' class='position-relative'>
        <div class="row">
            <fieldset class="w-100">
                <legend class="text-info">  مـعلومات العميل</legend>
                <div class="col-12">
...
<div class="form-group">
    <div class="col-12">
        <div class="d-flex justify-content-end align-items-center">
            <button class="btn btn-light btn-flat" type="button" id="cancel" data-dismiss="modal">الـغاء</button>
        </div>
    </div>
</div>
