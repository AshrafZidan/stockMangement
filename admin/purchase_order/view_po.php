...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">تفاصيل طلبية رقم - <?php echo $po_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">كود الطلبية</label>
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tfoot>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">الاجمالى الجزئي</th>
                        <th class="text-right py-1 px-2 sub-total"><?php echo number_format($total,2)  ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">الخصم <?php echo isset($discount_perc) ? $discount_perc : 0 ?>%</th>
                        <th class="text-right py-1 px-2 discount"><?php echo isset($discount) ? number_format($discount,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">الضرائب <?php echo isset($tax_perc) ? $tax_perc : 0 ?>%</th>
                        <th class="text-right py-1 px-2 tax"><?php echo isset($tax) ? number_format($tax,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">الاجمالى</th>
                        <th class="text-right py-1 px-2 grand-total"><?php echo isset($amount) ? number_format($amount,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">المدفوع</th>
                        <th class="text-right py-1 px-2 paid"><?php echo isset($paid) ? number_format($paid,2) : 0 ?></th>
                    </tr>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">المتبقى</th>
                        <th class="text-right py-1 px-2 remaining"><?php echo isset($remaining) ? number_format($remaining,2) : 0 ?></th>
                    </tr>
                </tfoot>
            </table>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="remarks" class="text-info control-label">ملاحظات الفاتورة</label>
                ...
                <div class="col-md-6">
                الحالة:
                    <span class="text-info"><?php echo ($status == 2)? "مستلمة" : "متستلمة جزئية" ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=purchase_order/manage_po&id='.(isset($id) ? $id : '') ?>">تـعديل</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=purchase_order' ?>">الرجوع الى القائمه</a>
    </div>
</div>
