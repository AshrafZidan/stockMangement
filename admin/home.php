<h1 class="">مرحبا  <?php echo $_settings->info('name') ?></h1>
<hr>
<div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <span class="info-box-text"> فواتير الشراء</span>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> فواتير المبيعات</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box bg-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text"> فواتير المبيعات المتاخرة</span>
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `sales_list`  WHERE `remaining` > 0  ")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
