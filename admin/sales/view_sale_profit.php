...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"> ارباح فاتورة رقم  - <?php echo $sales_code ? $sales_code:'' ?></h4>
    </div>
        ...
        <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <tbody>
                    ...
                    $total = 0;
                    $totalProfit = 0;
                    $qry = $conn->query("SELECT s.*,i.name,i.description,i.cost ,i.consumer_price FROM `stock_list` s inner join item_list i on s.item_id = i.id where s.id in ({$stock_ids})");
                ...
                <tfoot>
                    <tr>
                        <th class="text-right py-1 px-2" colspan="4">اجمالى ارباح الفاتورة</th>
                        <th class="text-right py-1 px-2 grand-total"><?php echo isset($totalProfit ) ? number_format($totalProfit ,2) : 0 ?></th>
                    </tr>
