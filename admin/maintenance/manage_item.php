...
<div class="container-fluid">
	<form action="" id="item-form">
		...
		<div class="form-group">
			<label for="cost" class="control-label">الـسعر</label>
			<input type="number" name="cost" id="cost" step="any" class="form-control rounded-0 text-end" value="<?php echo isset($cost) ? $cost : ''; ?>">
		</div>

		<div class="form-group">
			<label for="consumer_price" class="control-label">سعر المستهلك</label>
			<input type="number" name="consumer_price" id="consumer_price" step="any" class="form-control rounded-0 text-end" value="<?php echo isset($consumer_price) ? $consumer_price : ''; ?>">
		</div>
		...
		<div class="form-group">
			...
			<option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>نــشط</option>
